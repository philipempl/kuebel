...
const de: Record<string, string> = {
  ...
  update_version: "Version {v} ist da.",
  update_install: "Installieren",
  update_later: "Später",
  update_downloading: "Wird geladen … {p} %",
  update_ready: "Update installiert. Neu starten, um es zu verwenden.",
  update_restart: "Neu starten",
  update_failed: "Update fehlgeschlagen",
  update_retry: "Erneut versuchen",
  update_check: "Nach Updates suchen",
  update_checking: "Suche …",
  update_current: "kuebel ist aktuell.",
  update_found: "Version {v} verfügbar",
  update_install_version: "Version {v} installieren",
  update_check_failed: "Suche fehlgeschlagen",
...
const en: Record<string, string> = {
  ...
  update_version: "Version {v} is ready.",
  update_install: "Install",
  update_later: "Later",
  update_downloading: "Downloading … {p} %",
  update_ready: "Update installed. Restart to use it.",
  update_restart: "Restart",
  update_failed: "Update failed",
  update_retry: "Try again",
  update_check: "Check for updates",
  update_checking: "Checking …",
  update_current: "kuebel is up to date.",
  update_found: "Version {v} available",
  update_install_version: "Install version {v}",
